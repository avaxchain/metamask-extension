...
export default class TransactionController extends EventEmitter {
  ...
  */
              ...
              return reject(
                cleanErrorStack(
                  ethErrors.provider.userRejectedRequest(
                    'WutangMask Tx Signature: User denied transaction signature.',
                  ),
                ),
              )
              ...
              return reject(
                cleanErrorStack(
                  ethErrors.rpc.internal(
                    `WutangMask Tx Signature: Unknown problem: ${JSON.stringify(
   ...
   * new transaction contains the same nonce as the previous, is a basic AVAX transfer of 0x value to
