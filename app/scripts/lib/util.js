...
/**
 * Checks whether a given balance of AVAX, represented as a hex string, is sufficient to pay a value plus a gas fee
 *
 ...
 * @param {string} txParams.value - The value of AVAX to send
 * @param {string} hexBalance - A balance of AVAX represented as a hex string
