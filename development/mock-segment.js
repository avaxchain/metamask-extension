 ...
 * any)
 *
 * This can be used with the WutangMask extension by setting the `SEGMENT_HOST` environment
 * variable or config entry when building WutangMask.
 *
 * For example, to build WutangMask for use with this mock Segment server, you could set the
