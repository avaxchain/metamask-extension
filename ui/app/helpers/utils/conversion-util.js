 ...
 * @param {string} [options.fromCurrency = 'AVAX' | 'USD'] - The currency of the passed value
 * @param {string} [options.toCurrency = 'AVAX' | 'USD'] - The desired currency of the result
...
const toNormalizedDenomination = {
  ...
  AVAX: (bigNumber) => bigNumber.div(BIG_NUMBER_ETH_MULTIPLIER),
}
const toSpecifiedDenomination = {
  WEI: (bigNumber) => bigNumber.times(BIG_NUMBER_WEI_MULTIPLIER).round(),
  GWEI: (bigNumber) => bigNumber.times(BIG_NUMBER_GWEI_MULTIPLIER).round(9),
  AVAX: (bigNumber) => bigNumber.times(BIG_NUMBER_ETH_MULTIPLIER).round(9),
}
const baseChange = {
  hex: (n) => n.toString(16),
 ...
 * @typedef {('WEI' | 'GWEI' | 'AVAX')} EthDenomination
 */
